 ...
 *
 * Integrates sovendus network into the checkout process.
 *
 * 1.0.0
 * - initial release
 *
...
class OstSovendus extends Plugin
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_sovendus.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_sovendus.view_dir', $this->getPath() . '/Resources/views/');
